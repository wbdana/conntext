...
class GitFetchDirect extends React.Component {
  state = {
    githubUsername: '',
    repoName: '',
    filePath: '',
  ...
  render() {
    return(
      <Container textAlign='center' className="gitFetch">
        <div className='gitfetchlink'>No idea what you need? <NavLink to="/gitfetch" exact>Try GitFetch instead!</NavLink></div>
        ...
        <TSP />
        <Button onClick={this.fetchFile}>GitFetch Direct!</Button>
      </Container>
    )
  }
}

export default GitFetchDirect
