    ...
    <div className="about" >
      <Container className="about">
        ...
        <ul>
          ...
          <li>Sharing files: From a file's Editor page, you can add a collaborator to that file by entering their username (must be exact) in the appropriate field. Shared files will appear in your collaborator's Shared Files page.</li>
